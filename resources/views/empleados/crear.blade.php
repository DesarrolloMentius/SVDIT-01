                            ...
                            <form action="{{ route('empleados.store') }}" method="POST">
                                ...
                                <div class="row g-3">
                                    <div class="col">
                                        ...
                                        <input type="text" name="cedula" class="form-control" placeholder="N°"
                                            aria-label="Nombre">
                                    </div>
                                    <div class="col">
                                        <label for="text" class="form-label">Fecha de Expedicion</label>
                                        <input type="date" name="fecha_exp" class="form-control" aria-label="">
                                    </div>
                                    <div class="col">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col">
                                        <label for="text" style="margin-top:8px ;" class="form-label">Numero de
                                            contacto</label>
                                        <input type="number" name="numero_contacto" class="form-control"
